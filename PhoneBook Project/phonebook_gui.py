...
def load_gui(self):
    ...
    self.lbl_emailgrid(row=6, column=0, padx=(27,0), pady=(10,0), sticky=N+W)
    ...
    self.1stList1 = Listbox(self.master, export selection=0, yscrollcommand=self.scrollbar1.set)
